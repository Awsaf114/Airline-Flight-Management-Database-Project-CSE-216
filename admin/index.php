  ...
  <div class="form-container off-canvas">
    ...
    <form role="form" action="pages/index.php" method="post" class="form-signin" id="contact_form">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="EmployeeID" id="EmailAddress" aria-required="true" aria-invalid="true" autofocus required pattern="+">
      </div>
      ...
      <div class="form-group">
        ...
        <input type="password" class="form-control" name="password" id="password" aria-required="true" aria-invalid="true" required minlength="8" ">
      </div>
