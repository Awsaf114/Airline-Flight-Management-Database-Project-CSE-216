...
for(var it = 0 ; it< myObj.length; it++){
  ...
  var urls;
    ...
    for (var i = 0; i < images.length; i++) {
	  ...
	  urls='http://198.211.96.87/ospfinal/v1/'.concat(images[i]);
...
function loadAllanswers(event,Answerdiv){
